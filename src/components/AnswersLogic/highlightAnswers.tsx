...
export function highlightAnswersCheckbox(correctAnswers: UserAnswer[] | unknown, values: UserAnswer[] | unknown) {
...
export function highlightAnswersSelects(correctAnswers: UserAnswer | unknown, userAnswers: UserAnswer| unknown ) { 
