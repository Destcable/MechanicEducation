...
const AuthForm = (props: IAuthFormProps) => (
    <div className="container d-flex flex-column align-items-center justify-content-center min-vh-100">
        <h5 className="mb-4 text-center">Цифровой<br/> образовательный<br/> контент</h5>

        <img src={profLogoDark} alt="profLogoDark" style={{ width: '180px' }} />
        <form className='m-5 mt-4' onSubmit={props.onSubmit}>
